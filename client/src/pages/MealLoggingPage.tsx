...
export default function MealLoggingPage() {
  ...
  const foodDatabase = [
    ...
    { names: ['egg curry', 'anda curry', 'egg masala'], carbs: 8, protein: 15, fat: 14, calories: 220, sugar: 2 },
    { names: ['fish curry', 'meen curry', 'fish masala'], carbs: 8, protein: 25, fat: 12, calories: 240, sugar: 1 },
    { names: ['matar paneer', 'mutter paneer'], carbs: 14, protein: 12, fat: 16, calories: 250, sugar: 4 },
    { names: ['dal makhani', 'dal makhni', 'maa ki dal'], carbs: 30, protein: 13, fat: 14, calories: 290, sugar: 3 },
    { names: ['aloo gobi', 'aloo gobhi', 'alu gobi'], carbs: 22, protein: 5, fat: 7, calories: 165, sugar: 4 },
    { names: ['bhindi masala', 'bhindi', 'okra', 'bhendi'], carbs: 12, protein: 4, fat: 7, calories: 130, sugar: 3 },
    { names: ['kadhi', 'kadi', 'kadhi pakora'], carbs: 20, protein: 8, fat: 12, calories: 210, sugar: 3 },
    { names: ['baingan bharta', 'baingan ka bharta', 'eggplant curry'], carbs: 16, protein: 4, fat: 8, calories: 150, sugar: 5 },
    ...
    { names: ['pani puri', 'golgappa', 'puchka'], carbs: 30, protein: 4, fat: 6, calories: 180, sugar: 3 },
    { names: ['dahi puri', 'dahipuri'], carbs: 35, protein: 6, fat: 7, calories: 220, sugar: 5 },
    { names: ['misal pav', 'misal'], carbs: 48, protein: 14, fat: 12, calories: 350, sugar: 3 },
    { names: ['sabudana khichdi', 'sabudana khichadi', 'sago khichdi'], carbs: 42, protein: 5, fat: 8, calories: 260, sugar: 2 },
    { names: ['khichdi', 'khichadi', 'dal khichdi'], carbs: 45, protein: 10, fat: 6, calories: 280, sugar: 1 },
    { names: ['besan chilla', 'besan cheela', 'chickpea pancake'], carbs: 25, protein: 12, fat: 8, calories: 210, sugar: 2 },
    { names: ['moong dal chilla', 'moong cheela'], carbs: 20, protein: 14, fat: 6, calories: 180, sugar: 1 },
    { names: ['chicken tikka', 'tikka'], carbs: 5, protein: 28, fat: 10, calories: 220, sugar: 1 },
    { names: ['paneer tikka'], carbs: 8, protein: 18, fat: 16, calories: 260, sugar: 2 },
    { names: ['egg bhurji', 'egg burji', 'scrambled eggs'], carbs: 3, protein: 14, fat: 12, calories: 180, sugar: 1 },
    { names: ['tandoori chicken', 'tandoori murgh'], carbs: 3, protein: 30, fat: 12, calories: 240, sugar: 1 },
    { names: ['thepla', 'methi thepla'], carbs: 22, protein: 5, fat: 6, calories: 160, sugar: 1 },
    { names: ['raita', 'cucumber raita', 'boondi raita'], carbs: 8, protein: 4, fat: 4, calories: 80, sugar: 3 },
    { names: ['papad', 'papadum', 'papadom'], carbs: 8, protein: 2, fat: 3, calories: 60, sugar: 0 },
    { names: ['sprouts', 'sprouted moong', 'moong sprouts', 'sprouts salad'], carbs: 18, protein: 12, fat: 1, calories: 120, sugar: 2 },
    { names: ['fruit chaat', 'fruit chat'], carbs: 30, protein: 2, fat: 1, calories: 130, sugar: 20 },
